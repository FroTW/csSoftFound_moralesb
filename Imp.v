...
Proof.
  ...
  simpl_and_try repeat(rewrite -> optimize_0plus_sound); reflexivity.
Qed.
(** [] *)
...
Inductive bevalR: bexp -> bool -> Prop :=
  ...
  |E_BEq    : forall e1 e2 n m,
    aevalR e1 n -> aevalR e2 m -> bevalR (BEq e1 e2) (beq_nat n m)
  |E_BLe    : forall e1 e2 n m,
    aevalR e1 n -> aevalR e2 m -> bevalR (BLe e1 e2) (ble_nat n m)
  |E_BNot   : forall e b,
