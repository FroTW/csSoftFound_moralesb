...
Proof.
  ...
  Case "<-".
    ...
    SCase "beval is false".
      apply E_IfFalse; try assumption.
      inversion H5. apply negb_true_iff in H1.
      assumption.
    SCase "beval is true".
      apply E_IfTrue; try assumption.
      inversion H5. apply negb_false_iff in H1.
      assumption.
Qed.
...
Proof.
  ...
  Case "->".
    apply E_IfTrue; try rewrite <- Hbe; try apply Hc1e; assumption.
    apply E_IfFalse; try rewrite <- Hbe; try apply Hc2e; assumption.
  Case "<-".
    apply E_IfTrue; try rewrite Hbe; try apply Hc1e; assumption.
    apply E_IfFalse; try rewrite Hbe; try apply Hc2e; assumption.
Qed.
