...
Proof.
  unfold normal_form. exists (P (C 1) (C 2)).
  split.
  Case "left".
    apply v_funny.
  Case "right".
...
Lemma multistep_congr_2 : forall t1 t2 t2',
     ...
     P t1 t2 ==>* P t1 t2'.
Proof.
  intros t1 t2 t2' H IH. multi_cases (induction IH) Case.
  Case "multi_refl". apply multi_refl.
  Case "multi_step". eapply multi_step.
...
Proof.
  ...
  Case "P t1 t2".
    ...
    eapply multi_trans. apply multistep_congr_1. apply IHt1. apply H2.
    eapply multi_trans. apply multistep_congr_2. constructor. apply IHt2. apply H4.
