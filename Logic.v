...
Proof.
  ...
  inversion HPQ.
  Case "left". apply or_introl. apply H0.
  Case "mid".
    inversion HPR.
    SCase "left". apply or_introl. apply H1.
    SCase "right". apply or_intror. split. apply H0. apply H1.
Qed.
(** [] *)
...
(** Write an informal proof of [double_neg]:
   ...
   _Proof_: [P] implies False implies False. 
            [P] implies False equates to False.
...
(* P and ~ P yeilds False since only one can be True. ~ False equals True. *)
...
Theorem false_beq_nat : forall n m : nat,
     ...
     beq_nat n m = false.
Proof. 
  intros. destruct (beq_nat n m) eqn:eq.
  unfold not in H.
