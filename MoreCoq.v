...
Proof.
  intros n. induction n as [| n'].
    ...
    Case "n = 0".
      intros. simpl in H. destruct m. simpl in H. apply H. inversion H.
    Case "n = S n'".
...
Proof.
  ...
  Case "n = S n'".
    ...
    SCase "m = 0".
      simpl. intros H. inversion H.
    SCase "m = S m'".
      intros H. simpl in H. apply IHn' in H. rewrite -> H. reflexivity. Qed.
(** [] *)
...
Theorem index_after_last: forall (n : nat) (X : Type) (l : list X),
     ...
     index n l = None.
Proof.
  intros. generalize dependent n. induction l as [| l'].
  Case "l = []".
  ...
  Case "l = v :: l'".
    intros. rewrite <- H. simpl. rewrite -> IHl. reflexivity.
    reflexivity.
  Qed.
...
Proof.
  intros. unfold override. destruct (beq_nat k1 k2) eqn:J.
  rewrite <- H. apply beq_nat_true in J. apply f_equal. apply J.
  reflexivity. Qed.
(** [] *)
